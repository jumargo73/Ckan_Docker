...
def new() -> str:
    ...
    return base.render(u'noticias/new.html')
...
def new_1() -> str:
    ...
    return base.render(u'noticias/new_1.html')
    
def new_2() -> str:
     
    u''' display about page'''
   
    return base.render(u'noticias/new_2.html')   

def new_3() -> str:
     
    u''' display about page'''
   
    return base.render(u'noticias/new_3.html')      
